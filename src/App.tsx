...
export function AuthenticatorApp() {
  ...
  async function get() {
    ...
    const data = await getAccounts(login);
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span
                          className="absolute right-3 top-16 text-xs font-bold tracking-wider flex zzjustify-center items-center text-zinc-6500"
                          onClick={() => {
                            copyCode(2, a);
                          }}
                        >
