...
export default function AuthenticatorApp() {
    ...
    return (
        <>
            ...
            ></ToastContainer>
            <div
                className="min-h-screen bg-gradient-to-br from-zinc-900 to-black flex flex-col items-center py-10 text-white">
                {openCreateToTpModal && (
                    <ToTpCreate
                ...
                <div className="w-full max-w-md flex flex-col gap-6 p-4">
                    {accounts.length >= 1 ? (
                        ...
                        <div>
                            <span
                                className={"flex items-center justify-center"}>You haven't created any accounts yet!</span>
                            <span className={"flex items-center justify-center"}>Use the <Plus
                                className={"mr-1 ml-1 size-6"} color={"#808080"}/> symbol to create your first account.</span>
                        </div>
                    )}
                </div>
                ...
                <div
                    className="fixed bottom-0 w-full bg-zinc-900/90 border-t border-zinc-700 py-4 flex justify-center gap-6 shadow-2xl">
                    <button
